      ...
      <td className="p-3 text-lg text-gray-800 ">
        <div className="flex gap-2 items-center">
          <button
            ...
            className="bg-indigo-600 text-white rounded-lg w-full p-2 uppercase font-black text-xs cursor-pointer text-center hover:bg-indigo-500"
          > Editar
          </button>
          <Form
            className="w-full"
          ...
          >
            <input
              type="submit"
              value="Eliminar"
              className="bg-red-600 text-white rounded-lg w-full p-2 uppercase font-black text-xs cursor-pointer text-center hover:bg-red-500"
            />
          </Form>
        </div>
      </td>
